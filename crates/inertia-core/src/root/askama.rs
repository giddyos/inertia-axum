...
/// Inertia and optional root metadata.
#[derive(Clone, Copy)]
pub struct AskamaRootContext<'a> {
    /// Trusted, pre-rendered asset tags from the configured asset provider.
    ///
    /// This value is generated by `inertia-core`. In an HTML Askama template, render it with `|safe`. Do not apply `|safe` broadly to application or user-provided values.
