...
pub(crate) struct SsrEndpoints {
    pub(crate) render: http::Uri,
    pub(crate) health: Option<http::Uri>,
    pub(crate) shutdown: Option<http::Uri>,
}
...
fn endpoint(base: &str, path: &str) -> Result<http::Uri, SsrStartError> {
